...
from ..ldraw.network_filesystem import NetworkFileSystem as FileSystem
...
class ImportSettings:
    ...
    def load_settings(cls):
        # Use type.__setattr__ to bypass our own __setattr__ override which
        # tries to write into cls.settings before it's been assigned.
        type.__setattr__(cls, 'settings', helpers.read_json(cls.settings_path, cls.default_settings))
